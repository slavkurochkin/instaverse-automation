...
const commentOnStory = async (req, res) => {
    let commentId = Date.now().toString(36) + Math.random().toString(36).substring(2);
...
const deleteComment = async (req, res) => {
    ...
    const commentIndex = stories[storyIndex].comments.findIndex(c => c.commentId === commentId);
