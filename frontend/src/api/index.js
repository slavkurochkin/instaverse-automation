...
export const commentOnStory = async (id, comment) => api.post(`/stories/${id}/comment`, comment);


// Function to delete a comment from a story
export const deleteComment = async (storyId, commentId) => api.delete(`/stories/${storyId}/comments/${commentId}`);
